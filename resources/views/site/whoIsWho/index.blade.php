...
<div class="row team-row" style="margin: 30px auto 30px auto;">
    ...
    <div class="col-md-6 first" style="  transition: box-shadow .25s;   border-radius: 2px;
...
<img style="width: 200px;height: 165px !important;" src="/storage/{{ $item->photo }}" alt="">
</div>
<div class=" col-md-5">
...
<div class="col-md-5 first" style="   transition: box-shadow .25s; border-radius: 2px; background-color: #fff;box-shadow: 0 2px 5px 0 rgba(0,0,0,.16), 0 2px 10px 0 rgba(0,0,0,.12);margin: 30px auto 30px auto;">
    <div class="row" style="display: flex !important;">
        <div class="col-md-6" style="padding: 0!important;">
            <img style="width: 100% !important;height: 200px !important;" src="/storage/{{ $item->photo }}" alt="">
        </div>
        <div class=" col-md-5">
            <h4 style="font-size: 20px !important;line-height: 110%;margin: 1.14rem 0 0.912rem;padding-bottom: 3px;border-bottom: 1px solid #800000;font-weight: 400;font-size: 18px;">
         {{ $item->name }}
