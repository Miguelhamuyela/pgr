...
@section('titulo', 'Detalhes da Eleição')

@section('content')
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">
                <a href="{{ route('admin.elections.index') }}"><u>Listar Eleições</u></a> > {{ $election->date }}
            </h2>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="h3 m-4 page-title">{{ $election->title }}</h2>
                            ...
                            <div class="col">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-7 mb-2">
                                        <hr>
                                        <p class="mb-1 text-dark"><b>Data de Cadastro:</b> {{ $election->created_at }}
                                        </p>
                                        <p class="mb-1 text-dark"><b>Última Actualização:</b> {{ $election->updated_at }}
                                        </p>
                        ...
                        <div class="row align-items-center my-4">
                            ...
                            <div class="col-auto">
                                <a type="button" class="btn btn-lg btn-primary text-white"
                                    href="{{ url("admin/imagem-eleição/create/{$election->id}") }}">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href='{{ url("admin/imagem-eleição/delete/$item->id") }}'>{{ $item->id }}
                                                            - Eliminar</a>
                                                    </div>
                                                </div>
                                            </div>
