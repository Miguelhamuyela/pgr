                    ...
                    <div class="col-auto">
                        @isset($mandates)
                            <a type="button" class="btn btn-sm btn-primary text-white"
                                href="{{ url("admin/pgr/mandate/edit/{$mandates->id}") }}">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-7 mb-2">
                            <hr>
                            <p class="mb-1 text-dark"><b>Data de Cadastro:</b> {{ $mandates->created_at }}
                            </p>
                            <p class="mb-1 text-dark"><b>Última Actualização:</b> {{ $mandates->updated_at }}
                            </p>
