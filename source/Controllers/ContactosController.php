...
use Source\Models\Contactos as Model;
use Source\Models\Resposta as resposta;
...
class ContactosController {
  ...
  public function resposta($data)
  {
    ...
    $this->model1->nome = $data["nome"];
    $this->model1->email = $data["email"];
    $this->model1->assunto = $data["assunto"];


    $this->model1->mensagem = $data["mensagem"];
    ...
    $htmlParaEnviar = '
        ...
        <table width="100%"  cellspacing="0" cellpadding="0">
         ...
         sendEmail(["email" => $this->model1->email, "nome" => $this->model1->Nome_denunciante], $htmlParaEnviar);
