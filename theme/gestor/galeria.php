        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="ik ik-image" aria-hidden="true"></i> Adicionando uma nova Foto</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="store" action="<?= $router->route('galeria.create') ?>">
        ...
        <div class="modal fade" id="edit_<?= $key + 1 ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="update" action="https://pgr.ao/gestor/galeria/<?= $arquivo->id ?>">
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Escolha a Imagem desejada</label>
                                <input name="imagem" type="file" class="form-control">
                                <img style="width: 100%;" src="<?= URL_BASE_FILES . $arquivo->imagem ?>" alt="">
                            </div>
                            <div id="descricao" class="row">
                                <div class="form-group col-md-12">
                                    <label for="message-text" class="col-form-label">Descrição:</label>
                                    ...
                                    <div class="card task-board">
                                        <div class="card-header">
                                            <div class="card-header-right" style="top:5px !important;">
                                                <button data-toggle="modal" data-target="#edit_<?= $key + 1 ?>" class="btn btn-primary" type="button">
                                                    <i class="fa fa-edit fa-lg" aria-hidden="true"></i>
                                                    Editar
                                                </button>

                           <button class="galeria-eliminar btn btn-danger" target-id ="<?= $arquivo->id ?>" style="margin: 5px;" class="btn btn-danger" type="button"><i class="fa fa-trash fa-lg" aria-hidden="true"></i>Eliminar</button>
                                        ...
                                        <div class="card-body todo-task">
                                            <div style="-webkit-box-shadow: -1px 3px 8px 0px rgba(0,0,0,0.63);-moz-box-shadow: -1px 3px 8px 0px rgba(0,0,0,0.63);box-shadow: -1px 3px 8px 0px rgba(0,0,0,0.63);">
                                                <img style="object-fit: cover; width: 100%; height: 300px;" src="<?= URL_BASE_FILES . $arquivo->imagem ?>" alt="">
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div style="display: flex;">
                                                ...
                                                <h5 style="margin-left: 10px;">
                                                    <div style="display: -webkit-box;-webkit-line-clamp: 3;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis; height: 70px; margin-bottom: 6px;">
                                                        <?= $arquivo->descricao ?>
                                                    </div>
                                                </h5>
                                            </div>
