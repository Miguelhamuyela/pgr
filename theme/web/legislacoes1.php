                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10" style="margin: 0 auto !important;">
                        <div class="well-middle">
                            <div class="single-well">
                                ...
                                <p>
                                <?= $informacoe->descricao ?>
                                </p>
                                <ul>
                                    <li>
                                        <a href="<?= asset('assets/docs/constituicao_da_republica_de_angola.pdf') ?>" target="_blank"><i class="fa fa-check"></i>Constituição da República de Angola</a>
                                    </li>
                                    
                                    <li>
                                        <a href="<?= asset('assets/docs/lei_organica_da_pgr_e_do_mp.pdf') ?>" target="_blank"><i class="fa fa-check"></i>Lei 22/12 de 14 de Agosto - Lei Orgânica da Procuradoria Geral da República e do Ministério Público</a>
                                    </li>
                                    <li>
                                        <a href="<?= asset('assets/docs/lei_organica_conselho_superior_magistratura_ministerio_publico.pdf') ?>" target="_blank"><i class="fa fa-check"></i>Lei 15/11 de 18 de Março - Lei Orgânica do Conselho Superior da Magistratura</a>
                                    </li>
                                    <li>
                                        <a href="<?= asset('assets/docs/2018-2022_plano_estrategico_de_prevencao_e_combate_a_corrupcao.pdf') ?>" target="_blank"><i class="fa fa-check"></i>Plano Estratégico de Combate e Prevenção à Corrupção 2018-2022</a>
                                    </li>
