...
window.onload = function() {
  ...
  let botoesDeEliminarcont = Array.from(document.getElementsByClassName("contactos-eliminar"));

  if (botoesDeEliminarcont.length > 0) {
    botoesDeEliminarcont.forEach(botao => {
  ...
  let botoesDeEliminarnot = Array.from(document.getElementsByClassName("noticias-eliminar"));

  if (botoesDeEliminarnot.length > 0) {
    botoesDeEliminarnot.forEach(botao => {
        let id = botao.getAttribute("target-id");
  ...
  let botoesDeEliminargale = Array.from(document.getElementsByClassName("galeria-eliminar"));

  if (botoesDeEliminargale.length > 0) {
    botoesDeEliminargale.forEach(botao => {
        let id = botao.getAttribute("target-id");
  ...
  let botoesDeEliminarleg = Array.from(document.getElementsByClassName("legislacao-eliminar"));

  if (botoesDeEliminarleg.length > 0) {
    botoesDeEliminarleg.forEach(botao => {
        let id = botao.getAttribute("target-id");
    
        botao.addEventListener("click", function() {
            console.log(id);
    
            destroy(`${baseURL}/gestor/informacoes/${id}`);
