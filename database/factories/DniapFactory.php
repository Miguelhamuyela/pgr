...
class DniapFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'description' => "A Direcção Nacional de Investigação e Acção Penal (DNIAP) é um órgão da Procuradoria-Geral da República, criado à luz da lei n.º 22/12, de 14 de Agosto, em substituição do Departamento de Investigação e Instrução Criminal da Procuradoria-Geral da República – DIIC/PGR.
