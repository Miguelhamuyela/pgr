...
class CompositonFactory extends Factory
{
    ...
    {
        return [
            'title' => "     Composição da Procuradoria Geral da República – Artigo 143º (Lei Nº 36/11, de 21 de Dezembro)",
            'information' => "     1. A Procuradoria Geral da República é composta por dezassete membros, sendo:
                       ...
                       2. Os membros da Procuradoria Geral da República referidos na alínea b) do número anterior são
                        ...
                        partidos políticos.
                       3. A fixação do número de membros da Procuradoria Geral da República propostos pelos partidos
